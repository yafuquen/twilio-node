...
WebhookList = function WebhookList(version, serviceSid) {
   ...
   *          The list of comma-separated events that this Webhook is subscribed to.
 ...
 *          The string that you assigned to describe the webhook
 * @param {string|list} [opts.eventTypes] -
 *          The list of comma-separated events that this Webhook will subscribe to.
 * @param {string} [opts.webhookUrl] - The URL associated with this Webhook.
 * @param {webhook.status} [opts.status] - The webhook status
 * @param {function} [callback] - Callback to handle processed record
 *
 ...
 */
/* jshint ignore:end */
WebhookInstance.prototype.remove = function remove(opts, callback) {
 ...
 */
/* jshint ignore:end */
WebhookInstance.prototype.fetch = function fetch(opts, callback) {
 ...
 */
/* jshint ignore:end */
WebhookContext.prototype.remove = function remove(opts, callback) {
  if (_.isFunction(opts)) {
    callback = opts;
    opts = {};
  }
 ...
 */
/* jshint ignore:end */
WebhookContext.prototype.fetch = function fetch(opts, callback) {
  if (_.isFunction(opts)) {
    callback = opts;
    opts = {};
  }
